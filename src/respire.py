...
def get_arguments():
    ...
    parser.add_argument('-b', '-bash_command', dest='bash_command', type=bool,
                        default=False, help="Set for True to generate file with bash executed commands")
...
def run_HHblits(ident,seq_file):
    ...
    os.system("hhblits -cpu 10 -i {} -d ~{}/{} -oa3m {}.a3m".format(seq_file, path, base, ident)) #not finished yet to check with ferdi 
